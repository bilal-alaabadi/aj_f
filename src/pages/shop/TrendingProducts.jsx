...
import log from "../../assets/AJ_logo_62909C.png"; // شعار الأنثور
  ...
  return (
    <section className="section__container product__container">
      <div className="relative text-center" dir="rtl">
        {/* العنوانين */}
        <h2 className="text-[32px] font-normal text-[#62909C] mb-1">أستكشف مجموعاتنا المميزة</h2>
            ...
            return (
              ...
              >
                {oldPrice && oldPrice !== price && (
                  <div className="absolute top-3 left-3 bg-[#62909C] text-white text-xs font-bold px-2 py-1 rounded-full z-10">
      ...
      {visibleProducts < products.length && (
        <div className="product__btn text-center mt-8" dir="rtl">
          <button
            className="hover:bg-[#c19e22] bg-[#62909C] text-white px-6 py-2 rounded-md transition-colors"
